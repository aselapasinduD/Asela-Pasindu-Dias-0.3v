...
const ChildrenWithProps = (childrenProps: childrenProps) => {
    ...
    return (
        <div className={`aboutme flex flex-col bg-black w-[100%] h-[100%] ${className? className : ""}`}>
            ...
            <div className=" flex-grow flex flex-col ml-[90px] lg:ml-[120px] justify-evenly text-[1.1rem] xl:text-[1.24rem] leading-tight ">
                ...
                <p className=" w-[480px] xl:w-[660px] ml-[220px] font-light ">
                ...
                <p className=" ml-[220px] font-light ">
                ...
                <p className=" w-[500px] font-light ">
            ...
            <div className=" absolute top-[222px] xl:top-[233px] ml-[34px] lg:ml-[50px] ">
                <svg height="385">
